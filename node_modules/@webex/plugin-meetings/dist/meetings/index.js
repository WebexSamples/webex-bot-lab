...
var Meetings = /*#__PURE__*/function (_WebexPlugin) {
  ...
  (0, _createClass2.default)(Meetings, [{
    ...
    value: function setReachability() {
      this.reachability = new _reachability.default({}, {
        parent: this.webex
      });
    }
    /**
    ...
    value: function destroy(meeting, reason) {
      ...
      if (this.config.autoUploadLogs) {
        _loggerProxy.default.logger.info('Meetings:index#destroy --> Meeting destroyed, uploading logs');
        ...
        this.uploadLogs({
          ...
          _loggerProxy.default.logger.info('Meetings:index#destroy --> Upload logs for meeting completed.', uploadResult);
          ...
          _loggerProxy.default.logger.error('Meetings:index#destroy --> Unable to upload logs for meeting', uploadError);
